...
const Calculator: React.FC = () => {
  ...
  const calculateResults = () => {
    ...
    setResults({
        ...
        "withAppCostBenefit": Math.round(avgAnnualRevenue * 1.25 - avgAnnualRevenue - (avgOrders* 1.25 * avgCheckSize * .05 * 365))
    ...
    <div className="container mx-auto p-5 max-w-md">
        ...
        <div className="p-4">
            ...
            <div className="flex flex-wrap mb-3">
                ...
                <input type="text" id="averageCommission" pattern="\d*\.?\d*" onChange={e => setAverageCommission(e.target.value)} className="border p-2 rounded w-1/3 h-7" />
            </div>
            ...
            {results && (
                <div className="calculator-container">
                    ...
                    <thead>
                        <tr>
                        <th></th>
                        <th className="text-center">3rd Party Delivery</th>
                        <th className="text-center">Direct Ordering Only</th>
                        <th className="text-center">w/ App (all order types)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        ...
                        <td>${results["Annual Third Party Commissions/Fees"].toLocaleString()}</td>
                        <td>${results["Annual Third Party Net Revenue"].toLocaleString()}</td>
                        <td>${results["withAppCostBenefit"].toLocaleString()}</td>
                        </tr>
                    </tbody>
                    </table>
                </div>
